import{_ as e,Q as t,z as p,A as c,X as n,C as s,T as l,a6 as o}from"./framework.a7af28af.js";const i={},u=o(`<h1 id="设计模式-design-pattern" tabindex="-1"><a class="header-anchor" href="#设计模式-design-pattern" aria-hidden="true">#</a> 设计模式 Design pattern</h1><h2 id="单例模式-singleton" tabindex="-1"><a class="header-anchor" href="#单例模式-singleton" aria-hidden="true">#</a> 单例模式 Singleton</h2><p>类有且只有一个对象<br></p><ol><li>懒汉式</li></ol><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">//单例模式,垃圾桶</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="动态代理" tabindex="-1"><a class="header-anchor" href="#动态代理" aria-hidden="true">#</a> 动态代理</h3><blockquote><p>解决静态代理带来的高消耗,重复创建不同的代理</p></blockquote><p>通过反射实现,具体实现可参考文章:</p>`,28),d={href:"https://shane-1.io/java/AnnotationReflection.html#%E5%8F%8D%E5%B0%84",target:"_blank",rel:"noopener noreferrer"},r=n("h2",{id:"构建器模式-builder",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#构建器模式-builder","aria-hidden":"true"},"#"),s(" 构建器模式 Builder")],-1),k=n("p",null,"setXx()返回对象自身",-1),v=n("h2",{id:"观察者模式-observer",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#观察者模式-observer","aria-hidden":"true"},"#"),s(" 观察者模式 Observer")],-1),m=n("p",null,[s("Observers"),n("br"),s(" Observable"),n("br")],-1),b=n("hr",null,null,-1),h=n("p",null,"整理不易，转载请注明出处。",-1);function y(w,g){const a=t("ExternalLinkIcon");return p(),c("div",null,[u,n("p",null,[n("a",d,[s("反射和注解"),l(a)])]),r,k,v,m,b,h])}const f=e(i,[["render",y],["__file","DesignPattern.html.vue"]]);export{f as default};

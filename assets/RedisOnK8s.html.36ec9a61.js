import{_ as e,Q as t,z as i,A as p,X as s,C as n,T as l,a6 as c}from"./framework.a7af28af.js";const o="/images/2020-11-18-14-42-51.png",r="/images/2020-11-18-15-17-05.png",u={},d=s("h1",{id:"在k8s上部署redis-集群",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#在k8s上部署redis-集群","aria-hidden":"true"},"#"),n(" 在K8s上部署Redis 集群")],-1),v={href:"https://blog.csdn.net/zhutongcloud/article/details/90768390",target:"_blank",rel:"noopener noreferrer"},k=c(`<h2 id="一、前言" tabindex="-1"><a class="header-anchor" href="#一、前言" aria-hidden="true">#</a> 一、前言</h2><p>架构原理：每个Master都可以拥有多个Slave。当Master下线后，Redis集群会从多个Slave中选举出一个新的Master作为替代，而旧Master重新上线后变成新Master的Slave。</p><h2 id="二、准备操作" tabindex="-1"><a class="header-anchor" href="#二、准备操作" aria-hidden="true">#</a> 二、准备操作</h2><p>本次部署主要基于该项目：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>https://github.com/zuxqoj/kubernetes-redis-cluster
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+o+`" alt=""></p><p>创建相应目录</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[root@ftp quizii]# mkdir -p /usr/local/k8s/redis/pv{1..6}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如上，第一列为NodeId，稳定不变；第二列为IP和端口信息，可能会改变。</p><p>这里，我们介绍NodeId的两种使用场景：</p><p>当某个Slave Pod断线重连后IP改变，但是Master发现其NodeId依旧， 就认为该Slave还是之前的Slave。</p><p>当某个Master Pod下线后，集群在其Slave中选举重新的Master。待旧Master上线后，集群发现其NodeId依旧，会让旧Master变成新Master的slave。</p><p>对于这两种场景，大家有兴趣的话还可以自行测试，注意要观察Redis的日志。</p>`,107);function m(b,h){const a=t("ExternalLinkIcon");return i(),p("div",null,[d,s("p",null,[n("转载自"),s("a",v,[n("朱溪红的博客"),l(a)])]),k])}const y=e(u,[["render",m],["__file","RedisOnK8s.html.vue"]]);export{y as default};
